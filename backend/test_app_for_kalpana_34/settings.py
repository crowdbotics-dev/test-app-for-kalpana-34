"""
Django settings for test_app_for_kalpana_34 project.
...
ROOT_URLCONF = 'test_app_for_kalpana_34.urls'
...
WSGI_APPLICATION = 'test_app_for_kalpana_34.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Test app for kalpana Support <support@test-app-for-kalpana-34.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_app_for_kalpana_34 API",
    "DESCRIPTION": "API documentation for test_app_for_kalpana_34 App",
    "VERSION": "v1",
}
